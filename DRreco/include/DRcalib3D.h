...
private:
  ...
  Gaudi::Property<bool> m_dropBuffer{this, "dropBuffer", false, "Drop 3d hits outside the buffer"};
  Gaudi::Property<double> m_buffer{this, "bufferLength", 1000., "allowed buffer length outside the tower in mm"};
};
